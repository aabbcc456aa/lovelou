...
class Kindeditor::AssetsController < ApplicationController
  ...
  def list
    ...
    @file_list = []
    @current_path = "https://commondatastorage.googleapis.com/deviseuploader/uploads/image/201205/"
#    @current_path = "/home/huxl/projects/lovelou/public/uploads/image/"
    Dir.glob(@current_path) do |filename|  
      puts "=========#{filename}=="
      hash = {}
